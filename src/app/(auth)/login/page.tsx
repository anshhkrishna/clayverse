      ...
      <div className="w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-earth-500 mt-1">
            Sign in to your Clayverse studio
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  className="rounded border-earth-300 text-clay-500 focus:ring-clay-500"
                />
                <span className="text-xs text-earth-600">Remember me</span>
              </label>
              <Link
                href="/forgot-password"
                className="text-xs text-clay-600 hover:text-clay-700 transition-colors"
              >
                Forgot password?
              </Link>
            </div>
        ...
        <p className="text-center text-sm text-earth-500 mt-4">
          New to Clayverse?{" "}
          <Link href="/signup" className="text-clay-600 font-medium hover:text-clay-700 transition-colors">
            Create an account
          </Link>
        </p>
      </div>
